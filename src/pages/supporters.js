    ...
    <Layout>
      ...
      <Grid item xs={12} sm={12} md={8} lg={8} xl={8} mt={5}>
        ...
        <Typography mt={2} mb={3}>
          Code.org is sincerely grateful for our vibrant community of corporate,
          institutional, and individual donors. We acknowledge the following
          supporters who have made generous commitments of $1,000 and above to
          support our 2023 fiscal year (January 1, 2023 - December 31, 2023).
          For further details or to explore partnership opportunities with
          Code.org, please contact our Office of Development at giving@code.org.
          Code.org® believes that every student in every school should have the
          opportunity to learn computer science. Thanks to the support listed
          below, we are able to increase access to computer science education
          globally. Code.org is a 501(c)(3) nonprofit organization and our
          Federal Tax ID is 46-0858543.
        </Typography>
